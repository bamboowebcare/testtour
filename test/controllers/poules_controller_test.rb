...
class PoulesControllerTest < ActionController::TestCase
  ...
  test "should create poule" do
    assert_difference('Poule.count') do
      post :create, poule: { encrypted_password: @poule.encrypted_password, name: @poule.name, reset_password_token: @poule.reset_password_token, user_id: @poule.user_id }
    end
  ...
  test "should update poule" do
    patch :update, id: @poule, poule: { encrypted_password: @poule.encrypted_password, name: @poule.name, reset_password_token: @poule.reset_password_token, user_id: @poule.user_id }
    assert_redirected_to poule_path(assigns(:poule))
  end
